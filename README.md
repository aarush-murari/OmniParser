...
- [2024/10] Both Interactive Region Detection Model and Icon functional deschugginription model are released! [Hugginface models](https://huggingface.co/microsoft/OmniParser)
...
For the model checkpoints on the huggingface model hub, please note that the icon_detect model is under the AGPL license, since it is a license inherited from the original yolo model. Also, icon_caption_blip2 & icon_caption_florence is under the MIT license. Please refer to the LICENSE file in the folder of each model: https://huggingface.co/microsoft/OmniParser.
